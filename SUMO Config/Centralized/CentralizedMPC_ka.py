...
######## F.delaRosa Divide2x
    ...
    if phase == "phase 1":
        ...
        #     return int(160)
        if (KT_KL2.car_num <= 40 and 
            KR3_KT.car_num <= 20 and 
            KR3_TD.car_num <= 20 and 
            KL2_KSX.car_num <= 20 and 
            KNX_KR3.car_num <= 40 and #from 40
            KNX_UR.car_num <= 20 and
            AUR_AUL.car_num <= 20 and
            AUL_AUR.car_num <= 20 and
            AUR_KNX.car_num <= 20) :
            past_phases[0] = x
            return x
        ...
        if (past_phases[0] == 25 and past_phases[2] == 25 and past_phases[3] == 25):
            return int(70)
        if (BG_KT.car_num <= 12 and 
        BG_KL2.car_num <= 12 and
        BG_TD.car_num <= 12 and
        KR3_TD.car_num <= 12 and
        UR_KSX.car_num <= 12 and 
        FDR_KR3.car_num <= 12 and 
        FDR_KSX.car_num <= 12 and 
        FDR_UR.car_num <= 12 and
        KSX_AUR.car_num <= 12 and
        KB_AUL.car_num <= 12 and
        AUR_KNX.car_num <= 12 ):
            past_phases[1] = x            
            return x
        ...
        if (past_phases[0] == 25 and past_phases[1] == 25 and past_phases[3] == 25):
            return int(75)
        if (TD_KL2.car_num <= 15 and
            KT_UTURN.car_num <= 15 and 
            TD_BG.car_num <= 15 and 
            KR3_TD.car_num <= 15 and 
            TD_KT.car_num <= 15 and 
            UR_KSX.car_num <= 15 and 
            UR_KR3.car_num <= 15 and 
            KT_BG.car_num <= 15 and
            KNX_UR.car_num <= 15 and 
            AUR_KB.car_num <= 15 and 
            AUR_AUL.car_num <= 15 and 
            AUR_KNX.car_num <= 45):
            past_phases[2] = x
            return x
        ...
        if (past_phases[0] == 25 and past_phases[1] == 25 and past_phases[2] == 25):
            return int(70)
        if (KT_UTURN.car_num <= 25 
            and KT_KL2.car_num <= 100 # from 100
            and KT_TD.car_num <= 25 
            and KL2_UR.car_num <= 25 
            and KL2_KR3.car_num <= 25 
            and KL2_KSX.car_num <= 25
            and KT_BG.car_num <= 25):
            past_phases[3] = x
            return x
...
def run():
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if(traci.trafficlight.getPhase("kuf") in [0,3,6,9]):
            ...
            #print(str(kuf_phase_name),  + " and " + str(kuf_phase))
